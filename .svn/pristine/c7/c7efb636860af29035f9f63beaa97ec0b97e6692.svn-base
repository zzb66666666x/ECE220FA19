...
//the name of the tuple is: sp_tuples_node
...
//the struct sp_tuples contain information about the size of the matrix, number of non-zero elements and also the location of the starting node
