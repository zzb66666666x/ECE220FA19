...
.ORIG x3000
 ...
 ADD R3,R3,R2 		; R3 contains input number \-2		Now R3 contains 3 and R1 contains 5.
 LD R5,ZERO		; R5 now has initial value 0.
 			; (initializes outer count)
OUTERLOOP ADD R4,R0,R3 	; Copy outer count into inner count	R4 has 3, R3 has 3.
